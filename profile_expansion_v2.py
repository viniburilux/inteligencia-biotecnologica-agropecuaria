...
works = load_jsonl(NORM / "works_v1.jsonl")
actors = load_jsonl(NORM / "actors_v1.jsonl")
institutions = load_jsonl(NORM / "institutions_v1.jsonl")
relations = load_jsonl(NORM / "relations_v1.jsonl")
...
out = {
    ...
    "corpus_label": "cumulative_v1_after_expansion_v1",
    "metadata_only": True,
...
(ROOT / "EXPANSION_PROFILE_V2.json").write_text(json.dumps(out, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
